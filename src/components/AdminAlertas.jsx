...
const AdminAlertasForm = ({ initialData, onSave }) => {
  const [formState, setFormState] = useState(() => ({
    avisoActivo: Boolean(initialData?.avisoActivo),
    textoAviso: initialData?.textoAviso || "",
    telefonoContacto: initialData?.telefonoContacto || "",
    whatsappContacto: initialData?.whatsappContacto || "",
    instagramContacto: initialData?.instagramContacto || "",
    mensajePredefinido: initialData?.mensajePredefinido || "Hola, quisiera solicitar información sobre las consultas.",
    horarioGeneral: initialData?.horarioGeneral || "",
    direccionFisica: initialData?.direccionFisica || "",
    serviciosAdicionales: initialData?.serviciosAdicionales || [],
  }));
...
const AdminAlertas = () => {
  ...
  return (
    <section className="admin-panel-card">
      ...
      <AdminAlertasForm
        key={configuracion ? "loaded" : "default"}
        initialData={configuracion || defaultState}
        onSave={updateConfiguracion}
      />
    </section>
  );
};
